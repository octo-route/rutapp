...
-- 1) apply_immediate_sale_inventory: always use stock_almacen
...
begin
  ...
  -- No almacen → just record movement
...
-- 2) restore_cancelled_sale_inventory: always use stock_almacen
...
-- 3) apply_pedido_entregado_inventory: always use stock_almacen
...
-- 4) apply_delivered_direct_sale_inventory: always use stock_almacen
...
-- 5) recalc_producto_stock_total: only sum stock_almacen
