...
BEGIN
  ...
  -- Eliminar dependencias indirectas mediante triggers o llaves
  BEGIN DELETE FROM whatsapp_log WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM wa_campaign_sends WHERE campaign_id IN (SELECT id FROM wa_campaigns WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM wa_campaigns WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM wa_optouts WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM cupon_usos WHERE cupon_id IN (SELECT id FROM cupones WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM cupones WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM payment_links WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM notification_views WHERE notification_id IN (SELECT id FROM notifications WHERE user_id IN (SELECT user_id FROM profiles WHERE empresa_id = p_empresa_id)); EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM notifications WHERE user_id IN (SELECT user_id FROM profiles WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  ...
  BEGIN DELETE FROM cobro_reintentos WHERE cobro_id IN (SELECT id FROM cobros WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  ...
  BEGIN DELETE FROM venta_comisiones WHERE venta_id IN (SELECT id FROM ventas WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM venta_historial WHERE venta_id IN (SELECT id FROM ventas WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  ...
  -- Devoluciones, Cargas, Compras, Traspasos, Cotizaciones
  ...
  BEGIN DELETE FROM pago_compras WHERE compra_id IN (SELECT id FROM compras WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  ...
  BEGIN DELETE FROM cotizacion_lineas WHERE cotizacion_id IN (SELECT id FROM cotizaciones WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM cotizaciones WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  ...
  BEGIN DELETE FROM cajas WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  
  -- Rutas y Logística
  BEGIN DELETE FROM optimizacion_rutas_log WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM optimizacion_recargas WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM ruta_sesiones WHERE vendedor_id IN (SELECT id FROM vendedores WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM vendedor_ubicaciones_historial WHERE vendedor_id IN (SELECT id FROM vendedores WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM vendedor_ubicaciones WHERE vendedor_id IN (SELECT id FROM vendedores WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  ...
  BEGIN DELETE FROM stock_camion WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM ajustes_inventario WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  
  -- Gastos y Pagos
  BEGIN DELETE FROM gastos WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM pago_comisiones WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM solicitudes_pago WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM user_favorites WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
  
  -- Relaciones secundarias de productos/clientes
  BEGIN DELETE FROM combo_lineas WHERE combo_id IN (SELECT id FROM productos WHERE empresa_id = p_empresa_id) OR componente_id IN (SELECT id FROM productos WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  ...
  BEGIN DELETE FROM producto_tarifas WHERE producto_id IN (SELECT id FROM productos WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM producto_lotes WHERE producto_id IN (SELECT id FROM productos WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  ...
  BEGIN DELETE FROM promocion_aplicada WHERE promocion_id IN (SELECT id FROM promociones WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  ...
  BEGIN DELETE FROM cliente_orden_ruta WHERE cliente_id IN (SELECT id FROM clientes WHERE empresa_id = p_empresa_id); EXCEPTION WHEN OTHERS THEN END;
  
  -- Catálogos Operativos Básicos
  ...
  BEGIN DELETE FROM tarifas WHERE empresa_id = p_empresa_id AND nombre != 'Tarifa General'; EXCEPTION WHEN OTHERS THEN END;
  ...
  BEGIN DELETE FROM lista_precios WHERE empresa_id = p_empresa_id AND nombre != 'Lista General'; EXCEPTION WHEN OTHERS THEN END;
  
  BEGIN DELETE FROM listas WHERE empresa_id = p_empresa_id AND nombre != 'Lista General'; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM zonas WHERE empresa_id = p_empresa_id AND nombre != 'Zona General'; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM almacenes WHERE empresa_id = p_empresa_id AND nombre != 'Almacén General'; EXCEPTION WHEN OTHERS THEN END;
  BEGIN DELETE FROM unidades WHERE empresa_id = p_empresa_id AND nombre != 'Pieza'; EXCEPTION WHEN OTHERS THEN END;
  ...
  BEGIN DELETE FROM vehiculos WHERE empresa_id = p_empresa_id; EXCEPTION WHEN OTHERS THEN END;
