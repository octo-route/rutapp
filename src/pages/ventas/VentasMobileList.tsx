      ...
      {items.map((v) => {
        ...
        return (
          <MobileListCard
            key={v.id}
            title={
              v.clientes?.nombre || (v.cliente_id ? "—" : "Público en general")
            }
            ...
            fields={[
              ...
              {
                label: "Condición",
                value: CONDICION_LABELS[v.condicion_pago] || v.condicion_pago,
              },
              ...(v.saldo_pendiente > 0
                ? [
                    {
