...
import {
  ...
  LiveMobileApp,
  LiveDashboardMockup,
} from "@/components/landing/LiveMockups";

// ── Hero highlight: seguimiento en tiempo real ──
const REALTIME_BULLETS = [
  {
    icon: Radio,
    text: "Ubicación GPS de cada vendedor actualizada al instante",
  },
  {
    icon: Eye,
    text: "Mira qué cliente está visitando cada uno en este momento",
  },
  { icon: Activity, text: "Detecta ventas fuera de la ubicación del cliente" },
  {
    icon: Bell,
    text: "Alertas automáticas si un vendedor se desvía de la ruta",
  },
];
    ...
    items: [
      {
        ...
        desc: "Ubicación viva de cada vendedor en el mapa con histórico de recorrido y batería del dispositivo.",
      },
      {
        icon: Smartphone,
        title: "App móvil offline-first",
        desc: "Tus vendedores venden, cobran y registran gastos sin internet. Todo sincroniza al volver a línea.",
      },
      {
        icon: Route,
        title: "Optimización de rutas",
        desc: "Algoritmo Google Routes API + 2-opt. Ordena automáticamente la visita más eficiente del día.",
      },
      {
        icon: MapPin,
        title: "Mapa de clientes con GPS",
        desc: "Captura GPS al alta, navegación tipo Uber paso a paso y detección de visita.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "POS responsivo con búsqueda rápida, promociones nxm, descuentos y control de stock por almacén.",
      },
      {
        icon: Truck,
        title: "Pedidos y entregas",
        desc: "Flujo 1:N pedido → entregas. Despacha por ruta, marca entregado y descuenta inventario automático.",
      },
      {
        icon: Wallet,
        title: "Cobranza inteligente",
        desc: "Aplicación FIFO multi-folio, cobros parciales, liquidación de ruta con efectivo esperado vs real.",
      },
      {
        icon: Receipt,
        title: "Tickets y CFDI 4.0",
        desc: "Tickets térmicos por Bluetooth, PDFs estilo Odoo y facturación SAT con Facturama integrado.",
      },
    ],
  },
  {
    ...
    items: [
      {
        icon: Package,
        title: "Inventario multialmacén",
        desc: "Stock en tiempo real por almacén, traspasos con bloqueo de filas y kardex granular.",
      },
      {
        icon: ClipboardCheck,
        title: "Conteos físicos y auditorías",
        desc: "Reconciliación teórico vs físico desde móvil con PIN de supervisor para reapertura.",
      },
      {
        icon: RefreshCw,
        title: "Cargas y descargas de ruta",
        desc: "Arma cargas para camión, controla devoluciones y liquidación de mercancía sobrante.",
      },
      {
        icon: Tag,
        title: "Listas de precios y promociones",
        desc: "Múltiples tarifas por cliente, promociones nxm, descuentos por volumen y precios mayoreo.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "KPIs en vivo, ranking de vendedores, top productos y alertas de stock bajo mínimo.",
      },
      {
        icon: TrendingUp,
        title: "Reportes operativos",
        desc: "Ventas por cliente, producto, vendedor, utilidad, devoluciones, comisiones y cobertura de ruta.",
      },
      {
        icon: Calculator,
        title: "Cuentas por cobrar y pagar",
        desc: "Estados de cuenta por cliente y proveedor, antigüedad de saldos y aplicación FIFO.",
      },
      {
        icon: CreditCard,
        title: "Compras y proveedores",
        desc: "Órdenes de compra, recepción de mercancía, pagos parciales y saldos pendientes.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "Control fino por módulo y acción. Vista solo móvil, solo propios o acceso total.",
      },
      {
        icon: Eye,
        title: "Panel de auditoría y control",
        desc: "Detecta descuentos excesivos, ventas debajo del costo y anomalías operativas.",
      },
      {
        icon: Layers,
        title: "Multi-empresa y multi-moneda",
        desc: "Maneja varias empresas en una cuenta, con soporte multimoneda y zonas horarias.",
      },
      {
        icon: Building2,
        title: "Catálogo público compartible",
        desc: "Genera enlaces de catálogo por lista de precios. Tus clientes piden por WhatsApp.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "Envía tickets, estados de cuenta y campañas. Recordatorios automáticos de cobro.",
      },
      {
        icon: Bell,
        title: "Notificaciones automatizadas",
        desc: "Email + WhatsApp con branding propio. Avisos de pago, vencimientos y cumpleaños.",
      },
      {
        icon: ScanLine,
        title: "Importación masiva",
        desc: "Sube productos y clientes desde Excel/CSV con validación y autocreación de catálogos.",
      },
      {
        icon: WifiOff,
        title: "PWA instalable",
        desc: "Funciona como app nativa en Android, iOS y escritorio. Sin tiendas, sin descargas pesadas.",
      },
    ],
  },
];
...
const TESTIMONIALS = [
  {
    ...
    text: "El seguimiento en tiempo real cambió todo. Ahora sé exactamente dónde está cada vendedor y puedo reaccionar al instante.",
  },
  {
    name: "Ana R.",
    role: "Gerente de ventas",
    company: "Lácteos del Valle",
    text: "Mis vendedores venden desde el celular sin internet. Ya no hay papelitos ni errores en pedidos.",
  },
  {
    name: "Roberto S.",
    role: "Fundador",
    company: "Botanas Express",
    text: "La optimización de rutas nos ahorró miles de pesos en gasolina el primer mes. Se pagó solo.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
        ...
        <div className="fixed z-[60] top-5 left-1/2 -translate-x-1/2 w-[min(94vw,680px)]">
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, hsl(230, 55%, 52%), hsl(260, 45%, 60%), hsl(152, 56%, 45%))",
              }}
            />
            <div className="px-5 py-4 md:px-6 md:py-5 flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs md:text-sm text-gray-600 mt-1 leading-relaxed">
                  Estamos preparando tus datos de prueba. Te redirigiremos
                ...
                <div className="mt-3 h-1.5 w-full rounded-full bg-indigo-100/80 overflow-hidden">
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, hsl(230, 55%, 52%), hsl(260, 45%, 60%))",
                    }}
                  />
                </div>
              </div>
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100 pt-[env(safe-area-inset-top)]">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-[max(1.5rem,env(safe-area-inset-left))] h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link
              to="/signup"
              className="px-5 py-2.5 text-sm font-semibold text-white rounded-lg transition-all hover:opacity-90 shadow-lg shadow-indigo-500/25"
      ...
      <section className="pt-32 pb-16 px-6 relative">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, hsl(230, 55%, 52%), transparent)",
            }}
          />
          <div
            className="absolute top-60 -left-40 w-[400px] h-[400px] rounded-full opacity-[0.05]"
            style={{
              background:
                "radial-gradient(circle, hsl(260, 45%, 60%), transparent)",
            }}
          />
        </div>
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-[1.1] mb-6">
              ...
              <span className="block" style={{ color: "hsl(230, 55%, 52%)" }}>
                en vivo en el mapa
              </span>
            </h1>
            <p className="text-lg md:text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
              El ERP completo para distribuidoras y venta en ruta. Seguimiento
              GPS al instante, app móvil offline, optimización de rutas,
              inventario, cobranza y facturación CFDI — todo en un solo lugar.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
              <Link
                to="/signup"
                className="w-full sm:w-auto px-8 py-4 text-base font-bold text-white rounded-xl transition-all hover:opacity-90 shadow-xl shadow-indigo-500/30 flex items-center justify-center gap-2"
                style={{ background: "hsl(230, 55%, 52%)" }}
              >
              ...
              <a
                href="#realtime"
                className="w-full sm:w-auto px-8 py-4 text-base font-semibold text-gray-700 rounded-xl border-2 border-gray-200 hover:border-gray-300 transition-all flex items-center justify-center gap-2"
              >
                Conoce más <ChevronRight className="h-5 w-5" />
              </a>
            </div>
            <p className="text-xs text-gray-400 mt-4">
              Sin tarjeta · Configuración en 5 minutos · 7 días de prueba
            </p>
          </div>
          ...
          <div className="relative max-w-5xl mx-auto">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, hsl(230, 55%, 52%), hsl(260, 45%, 60%))",
              }}
            />
            <LiveDashboardMockup />
          </div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, white 0%, hsl(152, 56%, 97%) 100%)",
        }}
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-black tracking-tight leading-tight mb-5">
                ...
                <span className="block" style={{ color: "hsl(152, 56%, 38%)" }}>
                  de toda tu fuerza de ventas
                </span>
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                Olvídate de llamar para preguntar dónde está cada vendedor. El
                mapa de supervisión muestra la ubicación viva de todos, con qué
                cliente están, cuántas ventas llevan y hasta el nivel de
                batería.
              </p>
                  ...
                  <li key={b.text} className="flex items-start gap-3">
                    ...
                    >
                      <b.icon
                        ...
                        style={{ color: "hsl(152, 56%, 38%)" }}
                      />
                    </div>
                    <span className="text-sm md:text-base text-gray-700 pt-1.5">
                      {b.text}
                    </span>
                  </li>
                ))}
              ...
              <Link
                to="/signup"
                className="inline-flex items-center gap-2 px-6 py-3.5 text-sm font-bold text-white rounded-xl transition-all hover:opacity-90 shadow-lg"
                style={{
                  background: "hsl(152, 56%, 38%)",
                  boxShadow: "0 10px 25px -5px hsl(152, 56%, 38% / 0.4)",
                }}
              >
            ...
            <div className="relative">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, hsl(152, 56%, 50%), hsl(180, 56%, 50%))",
                }}
              />
              <LiveSupervisorMap />
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black tracking-tight">
              Navegación clara, todo a un clic
            </h2>
            <p className="text-gray-500 mt-3 max-w-xl mx-auto">
              8 módulos principales accesibles desde el sidebar. Diseñado para
              que cualquiera lo domine sin entrenamiento.
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black tracking-tight">
              Todo lo que OctoApp puede hacer por ti
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              Más de 30 funciones listas para usar, organizadas por área. Sin
              add-ons, sin sorpresas.
            </p>
          </div>
              ...
              <div key={group.title}>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {group.items.map((f) => (
                    <div
                      key={f.title}
                      className="p-5 rounded-2xl bg-white border border-gray-100 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300"
                    >
                      <div
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 mt-3">
              Así se ve OctoApp por dentro. Potente, limpio y fácil de usar.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center mb-20">
            <div>
              ...
              <p className="text-gray-500 mb-6 leading-relaxed">
                KPIs en tiempo real, tendencia de ventas, ranking de vendedores,
                alertas de stock bajo mínimo y utilidad neta. Todo en un solo
                vistazo.
              </p>
              <ul className="space-y-2.5">
                {[
                  "Ventas, cobros y gastos por período",
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center mb-20">
            ...
            <div className="md:order-2">
              ...
              <h3 className="text-2xl font-bold mb-3">
                Tu vendedor vende desde el celular
              </h3>
              <p className="text-gray-500 mb-6 leading-relaxed">
                Módulo móvil optimizado para trabajo en campo. Funciona sin
                internet y sincroniza automáticamente cuando hay conexión.
              </p>
              <ul className="space-y-2.5">
                {[
                  "Modo offline completo",
                  "Venta rápida con pedido sugerido",
                  "Cobro en efectivo y transferencia",
                  "GPS y navegación al cliente",
                ].map((t) => (
                  <li
                    key={t}
                    className="flex items-center gap-2 text-sm text-gray-600"
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h3 className="text-2xl font-bold mb-3">
                Ahorra gasolina y tiempo
              </h3>
              <p className="text-gray-500 mb-6 leading-relaxed">
                Optimización inteligente con Google Maps. Selecciona el día, los
                clientes y el punto de partida — y obtén la ruta más eficiente
                al instante.
              </p>
              <ul className="space-y-2.5">
                {[
                  "Algoritmo de Google Routes API",
                  "Ruta trazada en el mapa",
                  "Marcadores numerados por orden",
                  "Actualización automática del orden de visita",
                ].map((t) => (
                  <li
                    key={t}
                    className="flex items-center gap-2 text-sm text-gray-600"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold mb-5 tracking-widest bg-indigo-50 text-indigo-600 border border-indigo-100">
              <Zap className="h-3.5 w-3.5" /> PRECIOS DE LANZAMIENTO — TIEMPO
              LIMITADO
            </div>
            <h2 className="text-3xl md:text-5xl font-black tracking-tight text-gray-900 leading-tight">
              Todo lo que necesitas.
              <br />
              <span style={{ color: "hsl(230, 55%, 52%)" }}>
                A un precio que sorprende.
              </span>
            </h2>
            <p className="mt-4 text-lg max-w-xl mx-auto text-gray-500">
              Empieza hoy por menos de lo que cuesta un café al día. Sin
              contratos, sin sorpresas.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="relative rounded-3xl bg-white border-2 border-indigo-500 shadow-xl shadow-indigo-500/10 flex flex-col overflow-hidden transition-all duration-300 hover:-translate-y-1">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, hsl(230, 70%, 52%), hsl(260, 65%, 60%))",
                }}
              />
              ...
              <div className="p-7 flex flex-col flex-1">
                <div className="mb-5">
                  <div className="text-[10px] font-bold tracking-[0.2em] text-indigo-400 mb-1">
                    PLAN BASE
                  </div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    El cerebro de tu distribuidora
                  </p>
                </div>
                ...
                <div className="rounded-2xl p-4 mb-5 bg-indigo-50 border border-indigo-100">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className="inline-flex items-center gap-1 text-[11px] font-black px-2.5 py-0.5 rounded-full text-white"
                      style={{
                        background:
                          "linear-gradient(90deg, hsl(5, 80%, 55%), hsl(15, 85%, 55%))",
                      }}
                    >
                ...
                <div className="flex-1 mb-6">
                  <div className="text-[10px] font-bold tracking-widest text-gray-400 mb-3">
                ...
                <Link
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, hsl(230, 70%, 52%), hsl(255, 65%, 58%))",
                    boxShadow: "0 8px 24px hsl(230, 70%, 52% / 0.35)",
                  }}
                >
            ...
            <div className="relative rounded-3xl bg-white border border-gray-200 shadow-sm flex flex-col overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, hsl(38, 90%, 55%), hsl(20, 85%, 58%))",
                }}
              />

              <div className="p-7 flex flex-col flex-1">
                <div className="mb-5">
                  <div className="text-[10px] font-bold tracking-[0.2em] text-amber-500 mb-1">
                    ESCALA A TU RITMO
                  </div>
                  <h3 className="text-2xl font-black text-gray-900 tracking-tight">
                    Adicionales
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Agrega solo lo que necesitas, cuando lo necesitas
                  </p>
                </div>
                ...
                <div
                  className="flex-1 rounded-2xl overflow-hidden border-2 mb-6"
                  style={{
                    borderColor: "hsl(152, 56%, 40%)",
                    background:
                      "linear-gradient(145deg, hsl(152, 56%, 96%), hsl(180, 50%, 96%))",
                  }}
                >
                  <div className="p-4">
                    {/* Header with brand */}
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-0.5">
                          ...
                          <span
                            ...
                            style={{ color: "hsl(152, 56%, 25%)" }}
                          >
                            OctoRoute
                          </span>
                          <span
                            className="text-[9px] font-black px-1.5 py-0.5 rounded-md text-white tracking-wider"
                            style={{ background: "hsl(152, 56%, 38%)" }}
                          >
                            ADD-ON
                          </span>
                    ...
                    <div
                      ...
                      style={{
                        background: "hsl(152, 56%, 38% / 0.08)",
                        border: "1px solid hsl(152, 56%, 38% / 0.2)",
                      }}
                    >
                      <div
                        className="text-[9px] font-black tracking-widest mb-2.5"
                        style={{ color: "hsl(152, 56%, 30%)" }}
                      >
            ...
            <div className="relative rounded-3xl bg-white border border-gray-200 shadow-sm flex flex-col overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, hsl(42, 90%, 55%), hsl(28, 85%, 58%))",
                }}
              />
              ...
              <div className="p-7 flex flex-col flex-1">
                <div className="mb-5">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Sin vencimiento · Acumúlalos a tu ritmo
                  </p>
                </div>
                  ...
                  {[
                    ...
                    >
                      <div>
                        ...
                        <div className="text-[10px] mt-0.5 text-amber-600 font-semibold">
                          {pkg.perUnit}
                        </div>
                        {pkg.saving && (
                  ...
                  <div className="rounded-2xl p-4 bg-amber-50 border border-amber-100">
                    <div className="flex items-start gap-2.5">
                      ...
                      <div className="text-[11px] leading-relaxed text-gray-600">
                        ...
                        Emite CFDI 4.0 directo desde el POS o la app móvil. Sin
                        salir del sistema. Sin copiar-pegar.
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <Link
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, hsl(42, 80%, 50%), hsl(28, 80%, 52%))",
                    boxShadow: "0 6px 20px hsl(42, 70%, 50% / 0.25)",
                  }}
                >
                  Comprar Timbres →
                </Link>
            ...
            {[
              {
                icon: Shield,
                label: "Datos seguros",
                sub: "Encriptación SSL/TLS",
              },
              {
                icon: Zap,
                label: "Sin contratos",
                sub: "Mes a mes, sin ataduras",
              },
          ...
          <p className="text-center text-[11px] text-gray-400 mt-6">
            Precios de suscripción en MXN + IVA. Paquetes de timbres son precio
            neto. Sin permanencia.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, hsl(230, 55%, 48%), hsl(260, 45%, 52%))",
          }}
        >
          ...
          <div className="relative">
            ...
            <p className="text-indigo-100 text-lg mb-8 max-w-xl mx-auto">
              Únete a cientos de distribuidoras que ya optimizaron su operación
              con OctoApp.
            </p>
            <Link
              to="/signup"
      ...
      <footer className="border-t border-gray-100 py-10 px-[max(1.5rem,env(safe-area-inset-left))] pb-[max(2.5rem,env(safe-area-inset-bottom))]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-gray-500">
            <a href="#realtime" className="hover:text-gray-700">
              En vivo
            </a>
          ...
          <p className="text-xs text-gray-400">
            © {new Date().getFullYear()} OctoApp. Todos los derechos reservados.
          </p>
        </div>
      </footer>
    </div>
