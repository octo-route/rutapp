...
import {
  ...
  ProveedoresTabWrapper,
  KardexTabWrapper,
} from "./ProductoExtraTabs";
  ...
  return (
    <div className="p-4 min-h-full">
      <ProductoHeader
        form={h.form}
        set={h.set}
        setForm={h.setForm as any}
        isNew={h.isNew}
        isDirty={h.isDirty}
        starred={h.starred}
        setStarred={h.setStarred}
        editingName={h.editingName}
        setEditingName={h.setEditingName}
        nameInputRef={h.nameInputRef as any}
        imageInputRef={h.imageInputRef as any}
        uploadingImage={h.uploadingImage}
        handleImageUpload={h.handleImageUpload}
        handleSave={h.handleSave}
        handleDelete={h.handleDelete}
        onDiscard={() => h.navigate("/productos")}
      ...
      <div className="bg-card border border-border rounded px-4 pb-4 pt-3">
        <ProductoGeneralFields
          ...
          setForm={h.setForm as any}
          marcas={h.marcas}
          clasificaciones={h.clasificaciones}
          listas={h.listas}
          tarifasDisp={h.tarifasDisp as any}
          unidades={h.unidades}
          unidadesSat={h.unidadesSat}
          createMarca={h.createMarca}
          createClasificacion={h.createClasificacion}
          createUnidad={h.createUnidad}
          createLista={h.createLista}
        />
        <OdooTabs
          tabs={[
              ...
              ? [
                  {
                    ...
                    content: (
                      <PreciosTab
                        form={h.form}
                        tarifaLineas={h.tarifaLineas}
                        tarifasDisp={h.tarifasDisp}
                        productoId={h.id}
                        isNew={h.isNew}
                        navigate={h.navigate}
                      />
            ...
            },
            {
              key: "inventario",
              label: "Inventario",
              content: <InventarioTabContent form={h.form} set={h.set} />,
            },
            {
              key: "presentaciones",
            ...
            },
            {
              ...
              content: (
                <ProveedoresTabWrapper
                  ...
                  prodProveedores={h.prodProveedores ?? []}
                  saveProvMut={h.saveProvMut}
                  deleteProvMut={h.deleteProvMut}
                  createProveedor={h.createProveedor}
                />
              ),
            },
            {
              key: "kardex",
              label: "Kardex",
              content: <KardexTabWrapper productoId={h.id} isNew={h.isNew} />,
            },
          ]}
        />
      </div>
