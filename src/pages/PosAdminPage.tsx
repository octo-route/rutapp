                ...
                <table className="w-full text-xs text-left">
                  ...
                  <tbody className="divide-y">
                    <tr>
                      ...
                      <td className="px-3 py-2 text-right tabular-nums">{_fmt(totalEfectivoEsperado)}</td>
                      <td className="px-3 py-2 text-right tabular-nums">{t.status === 'abierto' ? '—' : _fmt(totalEfectivoContado)}</td>
                      <td className={`px-3 py-2 text-right tabular-nums font-semibold ${t.status === 'abierto' ? 'text-muted-foreground' : difEfectivo === 0 ? 'text-success' : difEfectivo < 0 ? 'text-destructive' : 'text-warning'}`}>
                        {t.status === 'abierto' ? '—' : (difEfectivo > 0 ? '+' : '') + _fmt(difEfectivo)}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-3 py-2 flex items-center gap-1.5 font-medium">
                      ...
                      <td className="px-3 py-2 text-right tabular-nums">{_fmt(totalTarjetaEsperado)}</td>
                      <td className="px-3 py-2 text-right tabular-nums">{t.status === 'abierto' ? '—' : _fmt(totalTarjetaContado)}</td>
                      <td className={`px-3 py-2 text-right tabular-nums font-semibold ${t.status === 'abierto' ? 'text-muted-foreground' : difTarjeta === 0 ? 'text-success' : difTarjeta < 0 ? 'text-destructive' : 'text-warning'}`}>
                        {t.status === 'abierto' ? '—' : (difTarjeta > 0 ? '+' : '') + _fmt(difTarjeta)}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-3 py-2 flex items-center gap-1.5 font-medium">
                      ...
                      <td className="px-3 py-2 text-right tabular-nums">{_fmt(totalTransferenciaEsperado)}</td>
                      <td className="px-3 py-2 text-right tabular-nums">{t.status === 'abierto' ? '—' : _fmt(totalTransferenciaContado)}</td>
                      <td className={`px-3 py-2 text-right tabular-nums font-semibold ${t.status === 'abierto' ? 'text-muted-foreground' : difTransferencia === 0 ? 'text-success' : difTransferencia < 0 ? 'text-destructive' : 'text-warning'}`}>
                        {t.status === 'abierto' ? '—' : (difTransferencia > 0 ? '+' : '') + _fmt(difTransferencia)}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-3 py-2 flex items-center gap-1.5 font-medium">
                      ...
                      <td className="px-3 py-2 text-right tabular-nums">{_fmt(totalOtrosEsperado)}</td>
                      <td className="px-3 py-2 text-right tabular-nums">{t.status === 'abierto' ? '—' : _fmt(totalOtrosContado)}</td>
                      <td className={`px-3 py-2 text-right tabular-nums font-semibold ${t.status === 'abierto' ? 'text-muted-foreground' : difOtros === 0 ? 'text-success' : difOtros < 0 ? 'text-destructive' : 'text-warning'}`}>
                        {t.status === 'abierto' ? '—' : (difOtros > 0 ? '+' : '') + _fmt(difOtros)}
                      </td>
                    </tr>
                  </tbody>
                </table>
