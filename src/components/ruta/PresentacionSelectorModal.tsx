...
export function PresentacionSelectorModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center bg-black/50 p-0 sm:p-4" onClick={onClose}>
      <div className="bg-card w-full sm:max-w-2xl lg:max-w-3xl rounded-t-2xl sm:rounded-2xl max-h-[95vh] sm:max-h-[90vh] flex flex-col shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <input type="number" inputMode={esGranel ? "decimal" : "numeric"} step={esGranel ? "0.001" : "1"} min="0" value={paquetes}
