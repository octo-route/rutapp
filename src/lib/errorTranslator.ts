...
const patterns: Array<{
  ...
  // Network / connectivity
  {
    ...
    result: {
      ...
      suggestion:
        "Seguiremos intentando automáticamente cuando vuelva la conexión.",
      icon: "network",
    },
  },
  // Edge function errors
  {
    ...
    result: {
      ...
      message:
        "Uno de nuestros servicios internos no respondió correctamente. Esto suele resolverse automáticamente.",
      suggestion:
        "Espera unos segundos y vuelve a intentarlo. Si persiste, contacta soporte.",
      icon: "server",
    },
  },
  // Auth errors
  {
    ...
    result: {
      ...
      message:
        "Hubo un problema al verificar tu identidad. Las credenciales podrían ser incorrectas o tu cuenta necesita verificación.",
      suggestion:
        "Revisa tu email y contraseña. Si acabas de registrarte, verifica tu correo electrónico.",
      icon: "auth",
    },
  },
  {
  ...
  // RLS / permission errors
  {
    ...
    result: {
      title: "Sin permisos",
      message:
        "No tienes permiso para realizar esta acción. Puede que necesites un rol diferente o que los datos pertenezcan a otra cuenta.",
      suggestion:
        "Contacta al administrador de tu empresa para solicitar los permisos necesarios.",
      icon: "permission",
    },
  },
  // Duplicate / unique constraint
  {
    ...
    result: {
      ...
      message:
        "Ya existe un registro con esos datos. No se puede crear uno idéntico.",
      suggestion:
        "Verifica que no estés duplicando información. Busca el registro existente y edítalo si necesitas hacer cambios.",
      icon: "data",
    },
  },
  // Foreign key errors
  {
    ...
    result: {
      ...
      message:
        "Este registro está vinculado a otros datos del sistema y no puede modificarse de esa forma.",
      suggestion:
        "Revisa que los datos relacionados (cliente, producto, almacén, etc.) existan y estén activos.",
      icon: "data",
    },
  },
  // Not null constraint
  {
    ...
    result: {
      ...
      message:
        "No se completaron todos los campos requeridos para guardar este registro.",
      suggestion:
        "Revisa el formulario y completa todos los campos marcados como obligatorios.",
      icon: "data",
    },
  },
  // Storage errors
  {
    ...
    result: {
      ...
      message:
        "Hubo un problema al subir el archivo. Puede ser demasiado grande o un formato no soportado.",
      suggestion:
        "Intenta con un archivo más pequeño (máximo 5MB) en formato JPG, PNG o PDF.",
      icon: "generic",
    },
  },
  // Email rate limit specific
  {
    ...
    result: {
      ...
      message:
        "Ya enviamos un correo recientemente. Para evitar spam, debes esperar un momento antes de solicitar otro.",
      suggestion:
        "Por favor, revisa tu bandeja de entrada y la carpeta de correo no deseado (spam) por si ya te llegó. Si no lo encuentras, intenta de nuevo en unos minutos.",
      icon: "auth",
    },
  },
  // Rate limit
...
export function translateError(error: unknown): ErrorExplanation {
  ...
  return {
    ...
    suggestion:
      "Intenta de nuevo. Si el problema persiste, contacta soporte técnico.",
    icon: "generic",
  };
}
